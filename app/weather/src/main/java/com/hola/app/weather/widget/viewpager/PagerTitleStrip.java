...
package com.hola.app.weather.widget.viewpager;
...
public class PagerTitleStrip extends ViewGroup implements ViewPager.Decor {
	...
	private class CircleIndicator extends View implements ViewPager.OnPageChangeListener{
		...
		public CircleIndicator(Context context, AttributeSet attrs) {
			super(context, attrs);
			mPaint.setStrokeWidth(context.getResources().getDisplayMetrics().density);
			if (attrs == null)
				return;
			TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.PagerTitleStrip);
			mIndicatorRadius = typedArray.getDimensionPixelSize(R.styleable.PagerTitleStrip_pts_radius,
					DEFAULT_INDICATOR_RADIUS);
			mIndicatorMargin = typedArray.getDimensionPixelSize(R.styleable.PagerTitleStrip_pts_margin,
					DEFAULT_INDICATOR_MARGIN);
			mIndicatorBackground = typedArray.getColor(R.styleable.PagerTitleStrip_pts_background,
					DEFAULT_INDICATOR_BACKGROUND);
			mIndicatorSelectedBackground = typedArray.getColor(R.styleable.PagerTitleStrip_pts_selected_background,

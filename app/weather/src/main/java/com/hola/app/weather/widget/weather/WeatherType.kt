...
annotation class WeatherType{
    companion object{
        const val DEFAULT = 0
        const val CLEAR_D = 1 //晴
        const val CLEAR_N = -1
        const val RAIN_D = 2 //雨
        const val RAIN_N = -2
        const val SNOW_D = 3 //雪
        const val SNOW_N = -3
        const val CLOUDY_D = 4 //多云
        const val CLOUDY_N = -4
        const val OVERCAST_D = 5 //阴天
        const val OVERCAST_N = -5
        const val FOG_D = 6 //雾
        const val FOG_N = -6
        const val HAZE_D = 7 //霾
        const val HAZE_N = -7
        const val SAND_D = 8 //沙尘
        const val SAND_N = -8
        const val WIND_D = 9 //风
        const val WIND_N = -9
        const val RAIN_SNOW_D = 10 //雨夹雪
